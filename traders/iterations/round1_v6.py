...
class MarketMakingStrategy(Strategy):
    def run(self) -> List[Order]:
        ...
        peso_mid=0.7
        fv = peso_mid * mid + (1-peso_mid) * ema
        ...
        # Split remaining capacity into Tight  and Deep 
        percentage_tight_buy = 0.5
        if buy_capacity > 0:
            tight_buy = int(buy_capacity * percentage_tight_buy)
        ...
        if sell_capacity > 0:
            tight_sell = int(sell_capacity * (1-percentage_tight_buy))
